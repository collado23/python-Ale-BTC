...
def bot_quantum_ayer():
    global contador_ops
    print("🚀 V15.8 ACTIVADA | MODO ESTABLE")
    ...
    while True:
        try:
            ...
            # Reporte de estado
            print(f"💰 WALLET: {total_w:.2f} | ACTIVAS: {len(reales)}/1 | TOTAL HOY: {contador_ops}")

            # Reconectar si hay algo abierto tras reinicio
            for r in reales:
            ...
            # Buscador (Solo 1 operación como ayer)
