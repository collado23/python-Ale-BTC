...
def vigilante_ayer(c, sym, side, q, entry, palanca):
    ...
    while True:
        try:
            ...
            # ROI de ayer (con 0.1% de comisión de Binance)
            ...
            # ESTO ES LO QUE TE MOSTRABA TODO AYER:
...
def bot_quantum_ayer():
    global contador_ops
    print("🚀 BOT REINSTALADO | MODO ESTABLE DE AYER")
    while True:
        try:
            ...
            # REPORTE DE ESTADO
            print(f"💰 WALLET: {total_w:.2f} | DISP: {disp:.2f} | ACTIVAS: {len(reales)}/1 | HOY: {contador_ops}")
            ...
            # BUSCADOR (Usa el 75% para que siempre supere los 5 USD de Binance)
